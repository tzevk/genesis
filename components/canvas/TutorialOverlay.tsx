...
export const OIL_GAS_TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    description: "Build a complete oil and gas pipeline by dragging components in the correct sequence. Pipes connect automatically when you place components correctly!",
    targetArea: "center",
    arrowDirection: "none",
  },
  {
    id: "task",
    title: "Task Panel",
    description: "This panel shows your objective: Build the Pipeline. Track your progress, see how many components you have placed, and monitor wrong attempts.",
    targetArea: "task",
    arrowDirection: "left",
  },
  {
    id: "timer",
    title: "Timer",
    description: "You have 3 minutes! The ring depletes as time passes. It turns yellow when you have 30 seconds left. Work quickly but carefully!",
    targetArea: "timer",
    arrowDirection: "left",
  },
  {
    ...
    description: "Drag components from here to the canvas. Place them in the correct order: Reservoir to Drilling to Platform to Pipeline to Separator to Storage to Tanker.",
  ...
  },
  {
    id: "build",
    title: "Canvas Area",
    description: "Drop components here! When placed in the correct sequence, pipes will automatically connect them. The canvas shows Upstream, Midstream, and Downstream zones.",
    targetArea: "build",
  ...
  },
  {
    ...
    description: "Click Submit when done to save your score. Use Reset to start over if needed. After 3 wrong placements, hints will appear to help you!",
    targetArea: "submit",
    arrowDirection: "left",
  },
];
