              ...
              {shuffledComponents.map(comp => {
                ...
                return (
                  <motion.div
                    ...
                    style={{ background: COLORS.glass, border: `1px solid ${isPlaced ? COLORS.amber : COLORS.glassBorder}`, minWidth: 70 }}
                  >
                    <div className="w-10 h-10 rounded flex items-center justify-center" style={{ background: `${COLORS.amber}15` }}>
                      {isPlaced ? (
                        <svg className="w-4 h-4" fill="none" stroke={COLORS.amber} strokeWidth="2.5" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                        </svg>
                      ) : (
