        ...
        >
          <div className="px-4 py-5">
            <div className="flex items-center gap-4">
              <p className="text-base font-bold flex-shrink-0" style={{ color: COLORS.cyan }}>
                ❄
              </p>
                  ...
                  return (
                    <motion.div
                      ...
                      style={{ 
                        ...
                        border: `2px solid ${isPlaced ? `${COLORS.neonGreen}40` : COLORS.glassBorder}`,
                      }}
                    >
                      <div 
                        className="w-16 h-16 rounded-xl flex items-center justify-center"
                        style={{ background: isPlaced ? `${COLORS.neonGreen}15` : `${COLORS.cyan}20` }}
                      >
                        {isPlaced ? (
                          <svg className="w-7 h-7" fill={COLORS.neonGreen} viewBox="0 0 24 24">
              ...
              <p className="text-base font-bold flex-shrink-0 px-4 py-2 rounded-xl" style={{ 
                color: COLORS.cyan, 
                background: `${COLORS.cyan}20`,
