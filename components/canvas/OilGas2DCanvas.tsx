...
export function OilGas2DCanvas({ 
  ...
  const TUTORIAL_STEPS = [
    {
      id: "welcome",
      title: "Oil & Gas Production Chain",
      description: "Learn how a complete oil & gas production system works. This simulation teaches you the upstream-to-downstream workflow.",
      highlight: null,
      icon: "welcome",
    },
    {
      ...
      description: "Understand how crude oil is extracted, processed, and transported. Figure out the correct sequence of 7 key components to build a working production chain.",
      highlight: null,
      icon: "toolbox",
    },
    {
      ...
      description: "Drag components from here onto the canvas. They're shuffled - use your engineering knowledge to determine the correct order!",
    ...
    },
    {
      id: "canvas",
      title: "Build Area",
      description: "Drop components here to build your plant. Think about the logical flow of oil & gas operations.",
      highlight: "canvas",
      icon: "canvas",
    },
    {
      ...
      description: "Track your time and score here. Watch for fault indicators if components are placed out of sequence!",
    ...
    },
    {
      ...
      description: "Apply your knowledge of oil & gas operations to complete the production chain. Good luck, Engineer!",
      highlight: null,
      icon: "start",
    },
  ];
  ...
  const MOBILE_TUTORIAL_STEPS = [
    {
      id: "welcome",
      title: "Oil & Gas Production Chain",
      description: "Learn how a complete oil & gas production system works from extraction to transport.",
      highlight: null,
      icon: "welcome",
    },
    {
      id: "concept",
      title: "What You'll Learn",
      description: "Figure out the correct sequence of 7 key components to build a working production chain.",
      highlight: null,
      icon: "toolbox",
    },
    {
    ...
    },
    {
      id: "canvas",
      title: "Drop Zone",
      description: "Drop components here. Think about the logical flow of oil & gas operations.",
      highlight: "canvas",
      icon: "canvas",
    },
    {
      id: "start",
      title: "Let's Go!",
      description: "Apply your oil & gas knowledge to complete the production chain. Good luck!",
      highlight: null,
      icon: "start",
    },
  ];
