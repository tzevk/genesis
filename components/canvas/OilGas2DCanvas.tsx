  ...
  const TUTORIAL_STEPS = [
    {
      ...
      description: "Arrange 7 components in the correct sequence to build a complete oil & gas production system.",
      highlight: null,
      icon: "welcome",
    },
    {
      id: "concept",
      title: "Your Task",
      description: "Drag and drop components from the toolbox to the canvas in the correct order from upstream to downstream.",
      highlight: null,
      icon: "toolbox",
    },
    {
      ...
      description: "Components are here. Drag each one onto the canvas in the correct sequence.",
    ...
    },
    {
      id: "canvas",
      title: "Build Area",
      description: "Drop components here. Place them in the correct order to complete the production chain.",
      highlight: "canvas",
      icon: "canvas",
    },
    {
      ...
      description: "Track your time, placed components, and wrong attempts here.",
    ...
    },
    {
      ...
      description: "Complete the production chain within the time limit. Good luck!",
      highlight: null,
      icon: "start",
    },
  ];
  ...
  const MOBILE_TUTORIAL_STEPS = [
    {
      id: "welcome",
      title: "Oil & Gas Production Chain",
      description: "Arrange 7 components in the correct sequence to build a production system.",
      highlight: null,
      icon: "welcome",
    },
    {
      id: "concept",
      title: "Your Task",
      description: "Place all components in order from upstream to downstream.",
      highlight: null,
      icon: "toolbox",
    },
    {
      ...
      description: "Tap and drag components from here onto the canvas.",
    ...
    },
    {
      id: "canvas",
      title: "Drop Zone",
      description: "Drop components here in the correct order.",
      highlight: "canvas",
      icon: "canvas",
    },
    {
